# 💫 About Me:
- 👩🏻‍💻 Travail en tant que développeur logiciel.<br>- ☀️ Contribution à des projets open-source, toujours ouvert aux nouveaux contributeurs (parfait pour les débutants !).<br>- ✍️ Écriture d'articles techniques pour partager mes connaissances.<br>- 🛠 Perfectionnement de mes compétences en **HTML**, **CSS**, **JavaScript**, **PHP**, **C++**, et **C#**.
...
![](https://github-contributor-stats.vercel.app/api?username=hoesaek&limit=5&theme=dark&combine_all_yearly_contributions=true)
